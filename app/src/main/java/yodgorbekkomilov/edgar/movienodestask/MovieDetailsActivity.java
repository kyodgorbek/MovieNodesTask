...
public class MovieDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addToFavoritesBtn = (Button) findViewById(R.id.add_favorite_btn);
...
*/
    ...
    private void getMovieDetails(final String id) {
        ...
        dialog.show();
        String url = "https://api.themoviedb.org/3/movie/" + id + "?api_key=4cb1eeab94f45affe2536f2c684a5c9e&language=en-US";
    ...
    private void getMovieVideos(final String id) {
        ...
        String url = "https://api.themoviedb.org/3/movie/" + id + "/videos?api_key=4cb1eeab94f45affe2536f2c684a5c9e&language=en-US";
        networkHelper.doNetworkRequestFor(url, new NetworkHelper.NetworkCallBack() {
            @Override
            public void onSuccess(String response) {
    ...
    private void getMovieReviews(String id) {
        ...
        String url = "https://api.themoviedb.org/3/movie/" + id + "/reviews?api_key=4cb1eeab94f45affe2536f2c684a5c9e&language=en-US";
        networkHelper.doNetworkRequestFor(url, new NetworkHelper.NetworkCallBack() {
            @Override
            public void onSuccess(String response) {
