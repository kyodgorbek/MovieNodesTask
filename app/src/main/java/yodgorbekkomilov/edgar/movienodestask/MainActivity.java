    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        popularitySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                String Url;
                if (i == 0) {
                    Url = "http://api.themoviedb.org/3/movie/popular?api_key=4cb1eeab94f45affe2536f2c684a5c9e";
                    loadMoviewList(Url);

                } else if (i == 1) {
                    Url = "http://api.themoviedb.org/3/movie/top_rated?api_key=4cb1eeab94f45affe2536f2c684a5c9e";
                    loadMoviewList(Url);
                } else if (i == 2) {
